define([
  ...
  var ExplorerViewModel = function (project, language) {
    ...
    self.initialize = function () {
      // This query is available in our main repository, along with an example of possible results.
      ...
      $.getJSON(g.paths.endpoint + '?project=' + encodeURIComponent(g.project) + '&default-graph-uri=internal&format=json&query=' + encodeURIComponent(metadataQuery),
        function (data) {
